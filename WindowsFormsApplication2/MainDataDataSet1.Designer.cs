...
namespace WindowsFormsApplication2 {
    ...
    public partial class MainDataDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/MainDataDataSet1.xsd";
        ...
        public partial class PurchaseDataTable : global::System.Data.TypedTableBase<PurchaseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PurchaseRow AddPurchaseRow(string Provider, double Count, double Time, double Money, string Tipe) {
        ...
        public partial class PurchaseRow : global::System.Data.DataRow {
            ...
            public double Count {
                get {
                    return ((double)(this[this.tablePurchase.CountColumn]));
                }
                set {
            ...
            public double Time {
                get {
                    return ((double)(this[this.tablePurchase.TimeColumn]));
                }
                set {
            ...
            public double Money {
                get {
                    return ((double)(this[this.tablePurchase.MoneyColumn]));
                }
                set {
...
namespace WindowsFormsApplication2.MainDataDataSet1TableAdapters {
    ...
    public partial class PurchaseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Purchase] WHERE (([Id] = @Original_Id) AND ([Provider] = @Orig" +
                "inal_Provider) AND ([Count] = @Original_Count) AND ([Time] = @Original_Time) AND" +
                " ([Money] = @Original_Money) AND ([Tipe] = @Original_Tipe))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Purchase] ([Provider], [Count], [Time], [Money], [Tipe]) VALUE" +
                "S (@Provider, @Count, @Time, @Money, @Tipe);\r\nSELECT Id, Provider, Count, Time, " +
                "Money, Tipe FROM Purchase WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Purchase] SET [Provider] = @Provider, [Count] = @Count, [Time] = @Time, [Money] = @Money, [Tipe] = @Tipe WHERE (([Id] = @Original_Id) AND ([Provider] = @Original_Provider) AND ([Count] = @Original_Count) AND ([Time] = @Original_Time) AND ([Money] = @Original_Money) AND ([Tipe] = @Original_Tipe));
SELECT Id, Provider, Count, Time, Money, Tipe FROM Purchase WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Provider, Count, Time, Money, Tipe FROM dbo.Purchase";
        ...
        public virtual int Delete(int Original_Id, string Original_Provider, double Original_Count, double Original_Time, double Original_Money, string Original_Tipe) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((double)(Original_Count));
        ...
        public virtual int Insert(string Provider, double Count, double Time, double Money, string Tipe) {
            if ((Provider == null)) {
        ...
        public virtual int Update(string Provider, double Count, double Time, double Money, string Tipe, int Original_Id, string Original_Provider, double Original_Count, double Original_Time, double Original_Money, string Original_Tipe, int Id) {
            if ((Provider == null)) {
                throw new global::System.ArgumentNullException("Provider");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((double)(Original_Count));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((double)(Original_Time));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((double)(Original_Money));
            if ((Original_Tipe == null)) {
                throw new global::System.ArgumentNullException("Original_Tipe");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Provider, double Count, double Time, double Money, string Tipe, int Original_Id, string Original_Provider, double Original_Count, double Original_Time, double Original_Money, string Original_Tipe) {
            return this.Update(Provider, Count, Time, Money, Tipe, Original_Id, Original_Provider, Original_Count, Original_Time, Original_Money, Original_Tipe, Original_Id);
        }
    }
